...
\end{theorem}
\begin{proof}
    Pro prvních $x$ tříd řešitelnosti přidáme jeden prvek $y_i$, přidáme blok obsahující všechna $y_i$ (pokud jich je více než 1) a zároveň prvek $y_i$ přidáme ke každému bloku \uv{své} třídy řešitelnosti.
    Tím získáme po řadě
    \begin{itemize}
