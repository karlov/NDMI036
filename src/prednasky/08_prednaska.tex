...
\begin{lemma}[Centrální kolineace jsou grupa (BD)]
...
\begin{theorem}[Kolineace tvoří grupu (BD)]
...
\begin{definition}[Sčítání na $P\setminus H$]
...
\begin{definition}[Operace s kolineacemi]
...
\end{theorem}
\begin{proof}
	% todo write idea 12 predn od 01:18:00
    TODO
\end{proof}
